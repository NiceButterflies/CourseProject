 ...
 * @author Евгения
 */
public class AddInstructorLogicImpl implements AddInstructorLogic {
    ...
    public String getSurname(int id) {
        ...
        return instructor.getInstructorCategory();
    }

    @Override
    public List getAllInstructors() {
        InstructorDAO sdao = new InstructorDAOImpl();
        return sdao.getInstructors();
    }
    ...
    public void saveInstructor(Instructor instructor) {
        ...
        if (instructor.getId() == 0) {
            Logger.getLogger(AddInstructorLogicImpl.class.getName()).log(Level.SEVERE, "\u0421\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u0438\u0435 \u043d\u043e\u0432\u043e\u0433\u043e \u0442\u043e\u0432\u0430\u0440\u0430{0}", instructor.toString());
            bdao.create(instructor);
        } else {
            Logger.getLogger(AddInstructorLogicImpl.class.getName()).log(Level.SEVERE, "Обновление данных о клиентах");
            bdao.update(instructor);
        }
    }
