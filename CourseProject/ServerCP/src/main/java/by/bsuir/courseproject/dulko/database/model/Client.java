 ...
 * @author Евгения
 */
public class Client extends DBObject implements Serializable {
    ...
    public String toString() {
        return "Client{" + "id=" + getId() + ", surname=" + surname + ", name=" + name + ", lastname=" + lastname + ", phoneNumber=" + phoneNumber + ", idDiscount=" + idDiscount + '}';
    }
